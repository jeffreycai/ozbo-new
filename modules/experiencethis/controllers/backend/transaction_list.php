...
$perpage = 50;
$total = Transaction::countAll();
$total_page = ceil($total / $perpage);
$html->renderOut('experiencethis/backend/transaction_list', array(
    'objects' => Transaction::findAllWithPage($page, $perpage),
    'current_page' => $page,
